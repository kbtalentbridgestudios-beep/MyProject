      ...
      {!loading && (
        <>
          ...
          <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-4 overflow-hidden">
            ...
            {/* Single Line Continuous Moving Text */}
            <div className="absolute top-0 left-0 w-full overflow-hidden z-20 bg-transparent">
              <p className="marquee-text text-orange-600 font-semibold py-3">
                Connecting Talent with Opportunities – Join us today!
              </p>
              ...
              <style>{`
                .marquee-text {
                  ...
                  white-space: nowrap;
                  width: 100%;
                  animation: singleMarquee 30s linear infinite;
