...
/* -------------------------------------------------- */
/*  1️⃣ CORS (SINGLE SOURCE OF TRUTH)                  */
/* -------------------------------------------------- */
...
// ✅ Let cors handle OPTIONS
app.options("*", cors());

/* -------------------------------------------------- */
/*  2️⃣ PHONEPE WEBHOOK (RAW BODY FIRST)               */
/* -------------------------------------------------- */
app.use(
...
try {
  ...
  console.warn("Cloudinary connection failed:", err?.message || err);
}
